...
if($_SESSION["nom"] && $_SESSION["prenom"] && $_SESSION["user"] && $_SESSION["promo"] && $_SESSION["semestre"] && $_SESSION["ref"] && $_SESSION["modifierId"]){
   ...
   <body>
      ...
      <nav class="nav2">
         ...
         <form action="ModiferCours.php" method="POST" class="activate" enctype="multipart/form-data">
            <h1>Modifer un Cours</h1>
            <label class="label" for="">partie cours</label>
            <input type="file" name="partieCoursm" id="partieCoursm">
            <label class="label" for="">partie td</label>
            <input type="file" name="partieTDm" id="partieTDm">
            <label class="label" for="">partie tp</label>
            <input type="file" name="partieTPm" id="partieTPm">
